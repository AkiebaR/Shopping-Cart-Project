 ...
 * Each item object contains a name, price, quantity, productId, and an image URL.
 */
const products = [
    {
  ...
  let cart = [];
  let totalPaid = 0; // Keeps track of the total amount paid by the customer.
  
  /**
   * @description Finds a product by its unique ID.
   * @param {number} productId - The unique ID of the product.
   * @param {Array} productList - The list of products to search through.
